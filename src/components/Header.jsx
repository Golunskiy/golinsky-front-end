...
const logo = "https://res.cloudinary.com/dw0qzruxp/image/upload/v1685200333/logo_qsmuvs.png";

function Header({ items, onDelBuy }) {
  const dispatch = useDispatch();
  const isOpened = useSelector((state) => state.cart.opened);
  const totalPrice = useSelector((state) => state.cart.totalPrice);

  if (isOpened) {
    document.body.style.overflow = "hidden"; // забираємо загальний скрол
  }
  ...
  return (
    <>
      {isOpened && <RightCart items={items} onDelBuy={onDelBuy} totalPrice={totalPrice} />}
      <div className="header">
        <NavLink to="/">
          <div className="header__left">
            <img src={logo} alt="123" width={40} height={40} />
            <div className="header__text">
              <h3>SNEAKERS SHOP</h3>
              <p>Магазин твого взуття</p>
            </div>
          </div>
        </NavLink>
